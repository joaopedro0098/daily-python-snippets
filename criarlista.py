...
#criei a nova lista para inserir os itens
#ciclo para verificar todas as listas existentes
#ciclo para iterar dentro de cada lista de estoque
#adicionei os itens das lista já existentes na lista nova
#tirei os itens repetidos
#converti para lista em python novamente
